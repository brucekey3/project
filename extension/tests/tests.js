...
let testUrls = [
  ...
  {
    url: "https://www.brit-method1.com/?campaign=21&btag=35054_395280_|afp0:PA_UK_Desktop_RON_Brit_NEW|afp2:2128561",
    containsIP: false
  },
  {
    url: "https://fakename.co.uk/?ipaddress=192.168.2.0",
    containsIP: true
  },
  {
    url: "https://fakename.co.uk/?ipaddress=9192.168.2.0",
    containsIP: false
  },
  {
    url: "https://fakename.co.uk/?ipaddress=192.168.2.999",
    containsIP: false
  }
];
...
function run_IP_regex_tests()
{
  ...
  for (let i in testUrls)
  {
    ...
    if (test.containsIP == res)
    {
      ...
      console.log("FAILED: Got: " + res + " expected: " + test.containsIP
                          + " for URL: " + test.url);

        testDiv.textContent = "FAILED: Got: " + res + " expected: " + test.containsIP
                            + " for URL: " + test.url;
